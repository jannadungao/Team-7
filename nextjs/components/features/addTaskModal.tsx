                                ...
                                <div className="space-y-2 p-8">
                                    ...
                                    <div className='flex gap-2 pt-2'>
                                        <button 
                                            ...
                                            className="mt-8 inline-flex w-full justify-center rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-white/20 sm:mt-0 sm:w-auto cursor-pointer flex-grow-1">
                                            Add Task
                                        </button>                                        
                                        <button
                                            type="button"
