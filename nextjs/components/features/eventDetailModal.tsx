                ...
                />
                    <div className="fixed inset-0 flex justify-center">
                        <div className="flex justify-center p-8 text-center items-center">
                            ...
                            >
                                {/* Close button */}
                                <button type="button" onClick={onClose} className="absolute top-0 right-0 p-4 cursor-pointer text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                                ...
                                <div className="flex flex-col h-full p-8">
                                    <h2 className="text-2xl mb-4 text-center text-gray-900 dark:text-gray-100">Event Details</h2>
                                    <div className="space-y-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">{event.event.title}</p>
                                        </div>
                                        {/* display start time */}
                                        <div>
                                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">Start Time:</label>
                                            <p className="text-lg text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">{startTime}</p>
                                        </div>
                                        {/* Display end time */}
                                        <div>
                                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-1">End Time:</label>
                                            <p className="text-lg text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">{endTime}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <button
                                            onClick={onClose}
                                            className="flex-1 bg-gray-100 dark:bg-gray-700 text-xl cursor-pointer text-gray-900 dark:text-white px-6 py-3 rounded-2xl font-medium transition-colors hover:bg-gray-200 dark:hover:bg-gray-600"
                                        >
                                            Close
                                        </button>
